...
$$H_0: Poisson~Homogeneo (Intensidad~constante) \\ vs. \\ H_a: Poisson~Inhomogeneo (Intensidad~no~constante) $$
...
R actualmente implementa una función de núcleo cuártico bidimensional:


$$ k(u) =  \left\{ \begin{array}{lcc}
             \frac{3}{\pi}(1-||u||^2)^2 &   si~~u \in (-1,1) \\
             \\~~ 0 &  e.o.c \\
             \end{array}
   \right.$$

donde $||u||^2 = u^2_1 + u^2_2$ es la norma al cuadrado del punto $u=(u_1,u_2)$.
...
A partir del conocimiento del tipo de patrón se pueden observar diversas zonas con mayor probabilidad de presentar puntos de recargas de la tarjeta cívica, además de otras zonas que aunque pertenecen a áreas urbanas presenta un mayor potencial para presentar nuevos puntos de recarga de la cívica.
